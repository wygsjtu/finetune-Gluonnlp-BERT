...
bert_classifier = nlp.model.BERTClassifier(bert_base, num_classes=52, dropout=0.1)
...
field_indices = [1,0]
data_train_raw = nlp.data.TSVDataset(filename='r52train.tsv',
...
data_test_raw = nlp.data.TSVDataset(filename='r52test.tsv',
                                 field_separator=field_separator,
                                 num_discard_samples=num_discard_samples,
                                 field_indices=field_indices)
