...
field_indices = [1,0]
data_train_raw = nlp.data.TSVDataset(filename='r8-train-all-terms.tsv',
...
all_labels = ["acq", "crude", "earn", "grain", "interest", "money-fx", "ship", "trade"]
...
data_test_raw = nlp.data.TSVDataset(filename='r8-test-all-terms.tsv',
                                 field_separator=field_separator,
                                 num_discard_samples=num_discard_samples,
                                 field_indices=field_indices)
