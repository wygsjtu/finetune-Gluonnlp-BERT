...
dev_dataloader = mx.gluon.data.DataLoader(data_test, batch_size=dev_batch_size, num_workers=4,
...
print('Time cost = {:.2f} s, throughput = {:.2f} samples/s'.format(toc-tic,
                 batch_size*len(dev_dataloader)/(toc - tic)))